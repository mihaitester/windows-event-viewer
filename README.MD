...
- `PathToEventFile` - In order to avoid the caveat, first copy the `.evtx` log file you are interested in outside the default folder and into a folder that does not require admin rights 
